const eventRegistration = (teamName) => {
	return `<!DOCTYPE html>
	<html>
	...
	<body>
		<div class="container">
			...
			<div class="body">
				<p>Hey , Team : ${teamName},</p>
				<p>Thankyou for registering for the event.</p>
				...
				<p>We can't wait to see what you'll bring to our club. Get started by exploring the events and setting up your profile.</p>
