const welcomeTemplate = (name) => {
	...
	<head>
		<meta charset="UTF-8">
		<title>Welcome to EventBreakers!</title>
		<style>
			body {
	...
	<body>
		<div class="container">
			...
			<div class="message">Welcome to EventBreakers!</div>
			<div class="body">
				<p>Dear ${name},</p>
				<p>We're thrilled to welcome you to EventBreakers! Your account has been successfully created and you're now part of our vibrant community.</p>
				<p>With EventBreakers, you can:</p>
				<ul style="text-align: left;">
					<li>Browse through events</li>
					<li>Register for them</li>
					<li>Recieve timely updates</li>
					<li>And much more!</li>
				</ul>
				<p>We can't wait to see what you'll bring to our club. Get started by exploring the events.</p>
